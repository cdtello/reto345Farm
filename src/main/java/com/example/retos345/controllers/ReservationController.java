...
public class ReservationController {    
    ...
    public ResponseEntity<List<Client>> getReservationsReportClients(){
        return new ResponseEntity<List<Client>>(this.reservationService.getReservationsReportClients(), HttpStatus.OK);
    }
